    ...
    <div class="mx-auto w-full max-w-[1600px] space-y-6 px-4 py-4 sm:px-6 lg:px-8">
        <section class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 sm:p-6">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                <div>
                    <span class="rounded-full bg-blue-50 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-blue-700 dark:bg-blue-500/15 dark:text-blue-300">Dashboard</span>
                    <h1 class="mt-4 text-3xl font-semibold tracking-tight text-gray-900 dark:text-white sm:text-4xl">Overview of your investment workspace</h1>
                    <p class="mt-2 max-w-3xl text-sm text-gray-500 dark:text-zinc-400">This page now follows the same layout proportions and card system as the rest of the application.</p>
                </div>
            </div>
        </section>

        <div class="grid gap-6 xl:grid-cols-3">
            <section class="relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 sm:p-6">
        ...
        <section class="relative min-h-[420px] overflow-hidden rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 sm:p-6">
            <x-placeholder-pattern class="absolute inset-0 size-full stroke-gray-900/10 dark:stroke-neutral-100/10" />
            <div class="relative max-w-2xl">
                ...
                <p class="mt-2 text-sm text-gray-500 dark:text-zinc-400">The container, spacing and card proportions are aligned with the assets and transactions pages.</p>
            </div>
        </section>
    </div>
</x-layouts.app>
